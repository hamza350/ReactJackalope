...
import WcirbSearch from './WcirbSearch';
import WcirbSearchResults from './WcirbSearchResults';
...
export class Wcirb extends React.Component {
  ...
  findBusiness(event, lastEmployerId, pagingDirection) {
    ...
    this.setState({businessPartialName: wcirbFindBusinessInput.businessPartialName});
    wcirbFindBusinessInput.lastEmployerId = lastEmployerId;
    wcirbFindBusinessInput.pagingDirection = pagingDirection;

    let url = utils.getServicesUrl() + '/findBusinessByNameGroupedByBureauNumber';
  ...
  getExModSearchInput() {
    let businessPartialName = $('#ID_WCIRB_PARTIAL_BUSINESS_NAME').val();
    //let bureauPartialNumber = $('#ID_WCIRB_BUREAU_NUM').val();
    //let selectedNinjaClasses = this.refs.WcirbSearch.getSelectedNinjaClasses();
    let selectedNinjaClasses = [];
    let wcirbFindBusinessInput = {
        businessPartialName: businessPartialName, resultsPerPage: this.resultsPerPage,
        bureauNumber: this.state.bureauNumber, effDateFrom: this.state.effDateFrom, effDateTo: this.state.effDateTo,
        groupByBureauNumber: true, selectedNinjaClasses: selectedNinjaClasses, streetAddress: this.state.streetAddress,
        city: this.state.city, zipCode: this.state.zip
    };
  ...
  initializeBusinessResponseData(response) {
    ...
    let businessData = businessUtils.parseWcirbBusinessSearchResults(response, this.state.businessPartialName);
      ...
      const subscribeLinkStyle = {
        ...
        return (
          <div className="ui-g-12">
              ...
              <WcirbSearch parentComponent={this} ref="WcirbSearch" />
              ...
              {this.state.showResults && (
                <div className="ui-g-12 no-padding">
                  <div className="ui-g-12 no-padding" id="ID_WCIRB_SUMMARY" style={{display: 'none'}}>
                    <WcirbSearchResults ref="businessSummary" parentComponent={this}
...
Wcirb.propTypes = {};
Wcirb.contextType = NinjaContext;