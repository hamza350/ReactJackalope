...
import WcirbExModClassCodeHistory from './WcirbExModClassCodeHistory';

const utils = new Utils();

export default class WcirbSearchResults extends Component {
    ...
    rowExpansionTemplate(data) {
      ...
      if(this.state.exModCcDataByBureauNumber[bureauNumber]) {
        ...
        return <WcirbExModClassCodeHistory parentComponent={this} data={innerGridData}  />;
      } else {
